...
b-bit 0 ------------ BRANCH: NEXT_CELL_up
--!
b-bit 1 ------------ BRANCH: NEXT_CELL_down
--!
b-bit 2 ------------ BRANCH: NEXT_CELL_left
--!
b-bit 3 ------------ BRANCH: NEXT_CELL_right
--!
acc 1 ------------ BRANCH_RECEIVER: NEXT_CELL_up
...
r4 0
bnez-cf ------------ BRANCH: NEXT_CELL_up_dec
--!
ret
rcrd 242 ------------ BRANCH_RECEIVER: NEXT_CELL_up_dec
...
ret
acc 1 ------------ BRANCH_RECEIVER: NEXT_CELL_down
rarb 242 -- move pointer to ID upper nibble first
--!
clr-cf
add-mba
...
r4 0
ret
from-reg 2 ------------ BRANCH_RECEIVER: NEXT_CELL_left
...
to-mdc
b-bit 3 ------------ BRANCH: NEXT_CELL_left_flow
--!
r4 0
ret
from-reg 2 ------------ BRANCH_RECEIVER: NEXT_CELL_right
rarb 245 -- store initial pointer for possible use later
--!
to-mba
from-reg 3
...
to-mdc
b-bit 0 ------------ BRANCH: NEXT_CELL_right_flow
--!
r4 0
ret
rarb 245 ------------ BRANCH_RECEIVER: NEXT_CELL_left_flow
--!
...
to-mdc -- store to lower nibble
r4 1
bnez-cf ------------ BRANCH: NEXT_CELL_left_flow_dec
--!
ret
rcrd 242 ------------ BRANCH_RECEIVER: NEXT_CELL_left_flow_dec
--! -- copy upper nibble address to RB:RA
from-mdc
to-reg 0
rcrd 243
...
dec*-mba -- decrease upper nibble if CF underflow bit is 1
ret
rarb 245 ------------ BRANCH_RECEIVER: NEXT_CELL_right_flow
--!
from-mba -- set pointer and RD:RC to initial
rarb 242
--!
...
ret -------------------- NEXT_CELL end
from-ioa ---------------------------------------- GAME_LOOP
rarb 253 -- store new direction to 253
--!
to-mba
to-reg 4
rarb 5
...
from-reg 4
beqz ------------ BRANCH: GAME_LOOP_oob_row
--!
rarb 6 -- compare column borders if oob
--!
acc 1100 -- 192, 197, 202, 207
xor-ba
bnez ------------ BRANCH: GAME_LOOP_oob_col_1101
--!
rarb 5
--!
acc 0b0000 -- 1100 + (lower nibble)
xor-ba
beqz ------------ BRANCH: GAME_DEATH
--!
...
beqz ------------ BRANCH: GAME_DEATH
--!
b ------------ BRANCH: GAME_LOOP_oob_row
--!
acc 1101 -- 212, 217, 222 ------------ BRANCH_RECEIVER: GAME_LOOP_oob_col_1101
xor-ba
bnez ------------ BRANCH: GAME_LOOP_oob_col_1110
--!
rarb 5
--!
...
b ------------ BRANCH: GAME_LOOP_oob_row
--!
acc 1110 -- 227. 232, 237 ------------ BRANCH_RECEIVER: GAME_LOOP_oob_col_1110
xor-ba
bnez ------------ BRANCH: GAME_LOOP_oob_row
--!
rarb 5
--!
...
b ------------ BRANCH: GAME_LOOP_oob_row
--!
acc 0b1100 ------------ BRANCH_RECEIVER: GAME_LOOP_oob_row
...
clr-cf
sub-mba
bnez-cf ------------ BRANCH: GAME_DEATH
--!
acc 1111 -- check if upper nibble is 1111
rarb 6
--!
xor-ba
bnez ------------ BRANCH: GAME_LOOP_food
--!
...
bnez-cf ------------ BRANCH: GAME_DEATH
--!
acc 0 ------------ BRANCH_RECEIVER: GAME_LOOP_food
rarb 244
--!
to-mba
...
beqz ------------ BRANCH: GAME_LOOP_food_ate
--! -- food was missed
rcrd 5
...
to-reg 4
bnez-cf ------------ BRANCH: GAME_LOOP_food_miss_queue-tail_dec
--!
b ------------ BRANCH: GAME_LOOP_food_miss_shift
--!
rarb 243 ------------ BRANCH_RECEIVER: GAME_LOOP_food_miss_queue-tail_dec
--!
dec*-mba
b ------------ BRANCH: GAME_LOOP_food_miss_shift
--!
acc 0b0000 ------------ BRANCH_RECEIVER: GAME_LOOP_food_miss_shift
rarb 243 -- if upper nibble is not 0b0000 then just skip lower nibble check
--!
xor-ba
bnez ------------ BRANCH: GAME_LOOP_food_miss_shift_cont
--!
...
bnez-cf ------------ BRANCH: GAME_LOOP_enqueue
--!
rarb 242 ------------ BRANCH_RECEIVER: GAME_LOOP_food_miss_shift_cont
...
sub-mba
to-mba
bnez-cf ------------ BRANCH: GAME_LOOP_food_miss_shift_dec
--!
b ------------ BRANCH: GAME_LOOP_food_miss_shift
--!
rarb 243 ------------ BRANCH_RECEIVER: GAME_LOOP_food_miss_shift_dec
--!
dec*-mba
b ------------ BRANCH: GAME_LOOP_food_miss_shift
--!
acc 1 ------------ BRANCH_RECEIVER: GAME_LOOP_food_ate
...
--!
inc*-mba
b ------------ BRANCH: GAME_LOOP_enqueue
--!
rcrd 11 ------------ BRANCH_RECEIVER: GAME_LOOP_enqueue
...
--!
from-mba
beqz ------------ BRANCH: GAME_LOOP
--!
b ------------ BRANCH: GAME_LOOP_food_spawn
--!
shutdown ------------ BRANCH: GAME_DEATH
rarb 253 ------------ BRANCH_RECEIVER: GAME_LOOP_food_spawn
...
.byte 0x00  -- food address ID (upper nibble)
.byte 0x00  -- food address MASK
.byte 0x00  ---- snake-tail address ID (lower nibble) = 192
.byte 0x0c  -- snake-tail address ID (upper nibble) = 192
.byte 0x00  -- snake-tail address MASK = 0b0000
